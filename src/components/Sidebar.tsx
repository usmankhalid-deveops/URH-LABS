...
export default function Sidebar({ activePage, setActivePage, user, onLogout, onToggleRole, isOpen, onClose }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { id: "voice-cloning", label: "Voice Cloning", icon: Sparkles, category: "AI Tools" },
    { id: "voice-design", label: "Voice Design", icon: Sliders, category: "AI Tools" },
    { id: "voice-conversion", label: "Voice Conversion", icon: RefreshCw, category: "AI Tools" },
    { id: "dubbing", label: "Dubbing", icon: SquarePlay, category: "AI Tools" },
